...
function buildHeader(vibe: VibeDefinition, ideName: string, isFree: boolean): string {
  ...
  lines.push(
    ...
    `# Generated by VibeCraftz (https://vibecraftz.vercel.app) — by changeshott`,
    `# Target: ${ideName}`,
  ...
  if (isFree) {
    lines.push(
      ...
      `# Upgrade to Pro at https://vibecraftz.vercel.app/pricing to remove this watermark,`,
...
function buildFooter(isFree: boolean): string {
  ...
  if (isFree) {
    lines.push("");
    lines.push("---");
    lines.push("*Generated with VibeCraftz Free — Upgrade at https://vibecraftz.vercel.app/pricing*");
  }
