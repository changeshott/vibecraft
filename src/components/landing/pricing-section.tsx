    ...
    <section id="pricing" className="py-24 md:py-32 relative">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div
          ...
          variants={fadeInUp}
          custom={4}
          className="mt-12 max-w-3xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 p-6 rounded-2xl border border-white/10 bg-white/[0.02] backdrop-blur-xl"
        >
          <div className="flex items-center gap-6 text-sm md:text-base text-white/60 font-medium w-full justify-center">
            <div className="flex items-center gap-2">
              <Users size={20} className="text-[#b1ff62]" />
              <span className="text-white font-bold">10,000+</span> developers trust us
            </div>
            <div className="hidden sm:block w-1 h-1 rounded-full bg-white/20" />
            <div className="flex items-center gap-2">
              <FolderCode size={20} className="text-[#b1ff62]" />
              Used in <span className="text-white font-bold">50,000+</span> projects
            </div>
          </div>
        </motion.div>
