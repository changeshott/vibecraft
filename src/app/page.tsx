...
function HeroSection() {
  return (
    <section className="relative min-h-[95vh] flex flex-col items-center justify-center pt-28 pb-20 md:pt-36 md:pb-28 overflow-hidden bg-[#090909]">
      ...
      <div className="absolute inset-0 opacity-[0.25] mix-blend-overlay pointer-events-none noise" />
      ...
      <div className="relative z-10 w-full max-w-5xl px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        ...
        <div className="relative w-full max-w-4xl mx-auto mt-10 md:mt-16 mb-24">
          ...
          <motion.div 
            ...
            className="relative backdrop-blur-[40px] bg-white/[0.03] border border-white/[0.08] rounded-[2rem] p-10 md:p-16 lg:p-24 text-center shadow-2xl"
          >
            {/* Headline */}
            <motion.h1
              ...
              className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tighter text-white leading-[1.05] tracking-tight"
            >
            ...
            <motion.p
              ...
              className="mt-8 text-base md:text-lg text-white/60 max-w-xl mx-auto leading-relaxed tracking-tight"
            >
...
function ProblemSection() {
  return (
    <section className="py-20 md:py-28 bg-[#090909] relative overflow-hidden">
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <motion.h2
            variants={fadeInUp}
            custom={0}
            className="text-3xl md:text-5xl font-bold tracking-tight text-white tracking-tight"
          >
        ...
        >
          ...
          <motion.div variants={fadeInUp} custom={2}>
            <div className="p-8 rounded-[2rem] border border-white/[0.08] bg-white/[0.02] backdrop-blur-xl hover:bg-white/[0.04] transition-colors duration-300 shadow-2xl h-full">
              ...
              <ul className="space-y-5 text-sm text-white/50 tracking-tight leading-relaxed">
                <li className="flex items-start gap-3">
                  <span className="text-white/20 mt-0.5">•</span>
                  generic colors — plain blue buttons on white background
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-white/20 mt-0.5">•</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-white/20 mt-0.5">•</span>
                  ai hallucinates random css libraries and packages
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-white/20 mt-0.5">•</span>
                  no animation guidelines — static, lifeless ui
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-white/20 mt-0.5">•</span>
                  mixed component patterns — every page feels different
                </li>
              </ul>
            </div>
          </motion.div>
          ...
          <motion.div variants={fadeInUp} custom={3}>
            <div className="p-8 rounded-[2rem] border border-[#b1ff62]/20 bg-[#b1ff62]/[0.03] backdrop-blur-xl hover:bg-[#b1ff62]/[0.05] transition-colors duration-300 shadow-2xl h-full relative overflow-hidden">
              ...
              <ul className="space-y-5 text-sm text-white/80 tracking-tight leading-relaxed relative z-10">
                <li className="flex items-start gap-3">
                  <span className="text-[#b1ff62] mt-0.5 font-bold">→</span>
                  curated color palette with strict anti-hallucination rules
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-[#b1ff62] mt-0.5 font-bold">→</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-[#b1ff62] mt-0.5 font-bold">→</span>
                  strict import rules — only approved packages allowed
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-[#b1ff62] mt-0.5 font-bold">→</span>
                  defined animation guidelines with timing and easing
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-[#b1ff62] mt-0.5 font-bold">→</span>
                  reusable component patterns — every page feels unified
                </li>
              </ul>
            </div>
          </motion.div>
...
function PricingSection() {
  return (
    <section id="pricing" className="py-24 md:py-32 bg-[#090909] relative overflow-hidden">
...
function PricingCard({ delay, title, badgeTitle, badgeColor, price, period, originalPrice, badge, desc, features, buttonType }: any) {
  return (
    <motion.div 
      variants={fadeInUp}
      custom={delay}
    ...
    >
      ...
      <button className={`w-full py-4 rounded-md text-xs font-bold uppercase tracking-widest transition-all mb-10 hover:scale-[1.02] active:scale-[0.98] ${
        buttonType === 'primary' 
...
function CTASection() {
  return (
    <section className="py-20 md:py-32 bg-[#090909] relative overflow-hidden">
      <div className="absolute inset-0 bg-white/[0.02]" />
      <div className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-[80vw] h-[80vw] max-w-[800px] max-h-[800px] bg-white/10 rounded-full blur-[150px] mix-blend-screen pointer-events-none" />
      <div className="absolute inset-0 opacity-[0.25] mix-blend-overlay pointer-events-none noise" />
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: false, amount: 0.15 }}
          className="p-10 md:p-16 rounded-[2.5rem] border border-white/[0.08] bg-white/[0.03] backdrop-blur-[40px] shadow-2xl"
        >
          <motion.h2
            variants={fadeInUp}
            custom={0}
            className="text-4xl md:text-6xl font-bold tracking-tight text-white tracking-tight leading-tight"
          >
            ready to craft <span className="text-[#b1ff62]">stunning ai output</span>?
          </motion.h2>
          <motion.p
            variants={fadeInUp}
            custom={1}
            className="mt-6 text-lg md:text-xl text-white/60 max-w-2xl mx-auto tracking-tight leading-relaxed"
          >
            join developers who are shipping beautiful, consistent uis with
            ai — in seconds, not hours.
          </motion.p>
          <motion.div variants={fadeInUp} custom={2} className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/generator"
              className={cn(
                "inline-flex items-center gap-3 px-10 py-4 text-sm font-bold rounded-xl",
                "bg-[#b1ff62] hover:bg-[#8eff00] text-black",
                "shadow-[0_0_30px_rgba(177,255,98,0.3)] hover:shadow-[0_0_40px_rgba(177,255,98,0.4)]",
