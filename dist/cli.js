#!/usr/bin/env node
"use strict";var Ht=Object.create;var Ne=Object.defineProperty;var zt=Object.getOwnPropertyDescriptor;var qt=Object.getOwnPropertyNames,He=Object.getOwnPropertySymbols,Yt=Object.getPrototypeOf,ze=Object.prototype.hasOwnProperty,Kt=Object.prototype.propertyIsEnumerable;var Jt=(e,t,s)=>t in e?Ne(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var ce=(e,t)=>{var s={};for(var o in e)ze.call(e,o)&&t.indexOf(o)<0&&(s[o]=e[o]);if(e!=null&&He)for(var o of He(e))t.indexOf(o)<0&&Kt.call(e,o)&&(s[o]=e[o]);return s};var qe=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var Zt=(e,t,s,o)=>{if(t&&typeof t=="object"||typeof t=="function")for(let r of qt(t))!ze.call(e,r)&&r!==s&&Ne(e,r,{get:()=>t[r],enumerable:!(o=zt(t,r))||o.enumerable});return e};var H=(e,t,s)=>(s=e!=null?Ht(Yt(e)):{},Zt(t||!e||!e.__esModule?Ne(s,"default",{value:e,enumerable:!0}):s,e));var _=(e,t,s)=>Jt(e,typeof t!="symbol"?t+"":t,s);var _e=qe((Ws,lt)=>{"use strict";var Ce={to(e,t){return t?`\x1B[${t+1};${e+1}H`:`\x1B[${e+1}G`},move(e,t){let s="";return e<0?s+=`\x1B[${-e}D`:e>0&&(s+=`\x1B[${e}C`),t<0?s+=`\x1B[${-t}A`:t>0&&(s+=`\x1B[${t}B`),s},up:(e=1)=>`\x1B[${e}A`,down:(e=1)=>`\x1B[${e}B`,forward:(e=1)=>`\x1B[${e}C`,backward:(e=1)=>`\x1B[${e}D`,nextLine:(e=1)=>"\x1B[E".repeat(e),prevLine:(e=1)=>"\x1B[F".repeat(e),left:"\x1B[G",hide:"\x1B[?25l",show:"\x1B[?25h",save:"\x1B7",restore:"\x1B8"},ds={up:(e=1)=>"\x1B[S".repeat(e),down:(e=1)=>"\x1B[T".repeat(e)},hs={screen:"\x1B[2J",up:(e=1)=>"\x1B[1J".repeat(e),down:(e=1)=>"\x1B[J".repeat(e),line:"\x1B[2K",lineEnd:"\x1B[K",lineStart:"\x1B[1K",lines(e){let t="";for(let s=0;s<e;s++)t+=this.line+(s<e-1?Ce.up():"");return e&&(t+=Ce.left),t}};lt.exports={cursor:Ce,scroll:ds,erase:hs,beep:"\x07"}});var At=qe((Er,Ve)=>{"use strict";var be=process||{},Ct=be.argv||[],fe=be.env||{},As=!(fe.NO_COLOR||Ct.includes("--no-color"))&&(!!fe.FORCE_COLOR||Ct.includes("--color")||be.platform==="win32"||(be.stdout||{}).isTTY&&fe.TERM!=="dumb"||!!fe.CI),Es=(e,t,s=e)=>o=>{let r=""+o,a=r.indexOf(t,e.length);return~a?e+Ts(r,t,s,a)+t:e+r+t},Ts=(e,t,s,o)=>{let r="",a=0;do r+=e.substring(a,o)+s,a=o+t.length,o=e.indexOf(t,a);while(~o);return r+e.substring(a)},_t=(e=As)=>{let t=e?Es:()=>String;return{isColorSupported:e,reset:t("\x1B[0m","\x1B[0m"),bold:t("\x1B[1m","\x1B[22m","\x1B[22m\x1B[1m"),dim:t("\x1B[2m","\x1B[22m","\x1B[22m\x1B[2m"),italic:t("\x1B[3m","\x1B[23m"),underline:t("\x1B[4m","\x1B[24m"),inverse:t("\x1B[7m","\x1B[27m"),hidden:t("\x1B[8m","\x1B[28m"),strikethrough:t("\x1B[9m","\x1B[29m"),black:t("\x1B[30m","\x1B[39m"),red:t("\x1B[31m","\x1B[39m"),green:t("\x1B[32m","\x1B[39m"),yellow:t("\x1B[33m","\x1B[39m"),blue:t("\x1B[34m","\x1B[39m"),magenta:t("\x1B[35m","\x1B[39m"),cyan:t("\x1B[36m","\x1B[39m"),white:t("\x1B[37m","\x1B[39m"),gray:t("\x1B[90m","\x1B[39m"),bgBlack:t("\x1B[40m","\x1B[49m"),bgRed:t("\x1B[41m","\x1B[49m"),bgGreen:t("\x1B[42m","\x1B[49m"),bgYellow:t("\x1B[43m","\x1B[49m"),bgBlue:t("\x1B[44m","\x1B[49m"),bgMagenta:t("\x1B[45m","\x1B[49m"),bgCyan:t("\x1B[46m","\x1B[49m"),bgWhite:t("\x1B[47m","\x1B[49m"),blackBright:t("\x1B[90m","\x1B[39m"),redBright:t("\x1B[91m","\x1B[39m"),greenBright:t("\x1B[92m","\x1B[39m"),yellowBright:t("\x1B[93m","\x1B[39m"),blueBright:t("\x1B[94m","\x1B[39m"),magentaBright:t("\x1B[95m","\x1B[39m"),cyanBright:t("\x1B[96m","\x1B[39m"),whiteBright:t("\x1B[97m","\x1B[39m"),bgBlackBright:t("\x1B[100m","\x1B[49m"),bgRedBright:t("\x1B[101m","\x1B[49m"),bgGreenBright:t("\x1B[102m","\x1B[49m"),bgYellowBright:t("\x1B[103m","\x1B[49m"),bgBlueBright:t("\x1B[104m","\x1B[49m"),bgMagentaBright:t("\x1B[105m","\x1B[49m"),bgCyanBright:t("\x1B[106m","\x1B[49m"),bgWhiteBright:t("\x1B[107m","\x1B[49m")}};Ve.exports=_t();Ve.exports.createColors=_t});var gs=require("util"),K=require("process"),q=H(require("readline"),1),ct=H(require("readline"),1);var Ye=(()=>{let e=/[\uD800-\uDBFF][\uDC00-\uDFFF]/g;return t=>{let s=0;for(e.lastIndex=0;e.test(t);)s+=1;return t.length-s}})(),Ke=e=>e===12288||e>=65281&&e<=65376||e>=65504&&e<=65510,Je=e=>e===8987||e===9001||e>=12272&&e<=12287||e>=12289&&e<=12350||e>=12441&&e<=12543||e>=12549&&e<=12591||e>=12593&&e<=12686||e>=12688&&e<=12771||e>=12783&&e<=12830||e>=12832&&e<=12871||e>=12880&&e<=19903||e>=65040&&e<=65049||e>=65072&&e<=65106||e>=65108&&e<=65126||e>=65128&&e<=65131||e>=127488&&e<=127490||e>=127504&&e<=127547||e>=127552&&e<=127560||e>=131072&&e<=196605||e>=196608&&e<=262141;var Qt=/[\u001b\u009b][[()#;?]*(?:[0-9]{1,4}(?:;[0-9]{0,4})*)?[0-9A-ORZcf-nqry=><]|\u001b\]8;[^;]*;.*?(?:\u0007|\u001b\u005c)/y,Xt=/[\x00-\x08\x0A-\x1F\x7F-\x9F]{1,1000}/y,Ze=/(?:(?![\uFF61-\uFF9F\uFF00-\uFFEF])[\p{Script=Han}\p{Script=Hiragana}\p{Script=Katakana}\p{Script=Hangul}\p{Script=Tangut}]){1,1000}/yu,es=/\t{1,1000}/y,Qe=new RegExp("[\\u{1F1E6}-\\u{1F1FF}]{2}|\\u{1F3F4}[\\u{E0061}-\\u{E007A}]{2}[\\u{E0030}-\\u{E0039}\\u{E0061}-\\u{E007A}]{1,3}\\u{E007F}|(?:\\p{Emoji}\\uFE0F\\u20E3?|\\p{Emoji_Modifier_Base}\\p{Emoji_Modifier}?|\\p{Emoji_Presentation})(?:\\u200D(?:\\p{Emoji_Modifier_Base}\\p{Emoji_Modifier}?|\\p{Emoji_Presentation}|\\p{Emoji}\\uFE0F\\u20E3?))*","yu"),ts=/(?:[\x20-\x7E\xA0-\xFF](?!\uFE0F)){1,1000}/y,ss=new RegExp("\\p{M}+","gu"),rs={limit:1/0,ellipsis:""},Xe=(e,t={},s={})=>{var P,j,G,X,ae,ne,O,ee;let o=(P=t.limit)!=null?P:1/0,r=(j=t.ellipsis)!=null?j:"",a=(G=t==null?void 0:t.ellipsisWidth)!=null?G:r?Xe(r,rs,s).width:0,i=0,n=(X=s.controlWidth)!=null?X:0,l=(ae=s.tabWidth)!=null?ae:8,u=(ne=s.emojiWidth)!=null?ne:2,g=2,d=(O=s.regularWidth)!=null?O:1,w=(ee=s.wideWidth)!=null?ee:g,p=[[ts,d],[Qt,i],[Xt,n],[es,l],[Qe,u],[Ze,w]],b=0,h=0,m=e.length,f=0,v=!1,C=m,R=Math.max(0,o-a),S=0,k=0,$=0,A=0;e:for(;;){if(k>S||h>=m&&h>b){let W=e.slice(S,k)||e.slice(b,h);f=0;for(let x of W.replaceAll(ss,"")){let N=x.codePointAt(0)||0;if(Ke(N)?A=g:Je(N)?A=w:A=d,$+A>R&&(C=Math.min(C,Math.max(S,b)+f)),$+A>o){v=!0;break e}f+=x.length,$+=A}S=k=0}if(h>=m)break e;for(let W=0,x=p.length;W<x;W++){let[N,B]=p[W];if(N.lastIndex=h,N.test(e)){if(f=N===Ze?Ye(e.slice(h,N.lastIndex)):N===Qe?1:N.lastIndex-h,A=f*B,$+A>R&&(C=Math.min(C,h+Math.floor((R-$)/B))),$+A>o){v=!0;break e}$+=A,S=b,k=h,h=b=N.lastIndex;continue e}}h+=1}return{width:v?R:$,index:v?C:m,truncated:v,ellipsed:v&&o>=a}},et=Xe;var is={limit:1/0,ellipsis:"",ellipsisWidth:0},os=(e,t={})=>et(e,is,t).width,M=os;var ue="\x1B",ot="\x9B",as=39,ke="\x07",at="[",ns="]",nt="m",Ie=`${ns}8;;`,tt=new RegExp(`(?:\\${at}(?<code>\\d+)m|\\${Ie}(?<uri>.*)${ke})`,"y"),st=e=>{if(e>=30&&e<=37||e>=90&&e<=97)return 39;if(e>=40&&e<=47||e>=100&&e<=107)return 49;if(e===1||e===2)return 22;if(e===3)return 23;if(e===4)return 24;if(e===7)return 27;if(e===8)return 28;if(e===9)return 29;if(e===0)return 0},rt=e=>`${ue}${at}${e}${nt}`,it=e=>`${ue}${Ie}${e}${ke}`,Se=(e,t,s)=>{let o=t[Symbol.iterator](),r=!1,a=!1,i=e.at(-1),n=i===void 0?0:M(i),l=o.next(),u=o.next(),g=0;for(;!l.done;){let d=l.value,w=M(d);n+w<=s?e[e.length-1]+=d:(e.push(d),n=0),(d===ue||d===ot)&&(r=!0,a=t.startsWith(Ie,g+1)),r?a?d===ke&&(r=!1,a=!1):d===nt&&(r=!1):(n+=w,n===s&&!u.done&&(e.push(""),n=0)),l=u,u=o.next(),g+=d.length}i=e.at(-1),!n&&i!==void 0&&i.length&&e.length>1&&(e[e.length-2]+=e.pop())},ls=e=>{let t=e.split(" "),s=t.length;for(;s&&!M(t[s-1]);)s--;return s===t.length?e:t.slice(0,s).join(" ")+t.slice(s).join("")},cs=(e,t,s={})=>{var d,w,p,b;if(s.trim!==!1&&e.trim()==="")return"";let o="",r,a,i=e.split(" "),n=[""],l=0;for(let h=0;h<i.length;h++){let m=i[h];if(s.trim!==!1){let v=(d=n.at(-1))!=null?d:"",C=v.trimStart();v.length!==C.length&&(n[n.length-1]=C,l=M(C))}h!==0&&(l>=t&&(s.wordWrap===!1||s.trim===!1)&&(n.push(""),l=0),(l||s.trim===!1)&&(n[n.length-1]+=" ",l++));let f=M(m);if(s.hard&&f>t){let v=t-l,C=1+Math.floor((f-v-1)/t);Math.floor((f-1)/t)<C&&n.push(""),Se(n,m,t),l=M((w=n.at(-1))!=null?w:"");continue}if(l+f>t&&l&&f){if(s.wordWrap===!1&&l<t){Se(n,m,t),l=M((p=n.at(-1))!=null?p:"");continue}n.push(""),l=0}if(l+f>t&&s.wordWrap===!1){Se(n,m,t),l=M((b=n.at(-1))!=null?b:"");continue}n[n.length-1]+=m,l+=f}s.trim!==!1&&(n=n.map(h=>ls(h)));let u=n.join(`
`),g=!1;for(let h=0;h<u.length;h++){let m=u[h];if(o+=m,g)g=!1;else if(g=m>="\uD800"&&m<="\uDBFF",g)continue;if(m===ue||m===ot){tt.lastIndex=h+1;let f=tt.exec(u),v=f==null?void 0:f.groups;if((v==null?void 0:v.code)!==void 0){let C=Number.parseFloat(v.code);r=C===as?void 0:C}else(v==null?void 0:v.uri)!==void 0&&(a=v.uri.length===0?void 0:v.uri)}if(u[h+1]===`
`){a&&(o+=it(""));let f=r?st(r):void 0;r&&f&&(o+=rt(f))}else m===`
`&&(r&&st(r)&&(o+=rt(r)),a&&(o+=it(a)))}return o},us=/\r?\n/;function z(e,t,s){return String(e).normalize().split(us).map(o=>cs(o,t,s)).join(`
`)}var E=H(_e(),1),Ae=require("tty");function Y(e,t,s){var i;if(!s.some(n=>!n.disabled))return e;let o=e+t,r=Math.max(s.length-1,0),a=o<0?r:o>r?0:o;return(i=s[a])!=null&&i.disabled?Y(a,t<0?-1:1,s):a}var fs=["up","down","left","right","space","enter","cancel"],bs=["January","February","March","April","May","June","July","August","September","October","November","December"],T={actions:new Set(fs),aliases:new Map([["k","up"],["j","down"],["h","left"],["l","right"],["","cancel"],["escape","cancel"]]),messages:{cancel:"Canceled",error:"Something went wrong"},withGuide:!0,date:{monthNames:[...bs],messages:{required:"Please enter a valid date",invalidMonth:"There are only 12 months in a year",invalidDay:(e,t)=>`There are only ${e} days in ${t}`,afterMin:e=>`Date must be on or after ${e.toISOString().slice(0,10)}`,beforeMax:e=>`Date must be on or before ${e.toISOString().slice(0,10)}`}}};function Te(e,t){if(typeof e=="string")return T.aliases.get(e)===t;for(let s of e)if(s!==void 0&&Te(s,t))return!0;return!1}function xs(e,t){if(e===t)return;let s=e.split(`
`),o=t.split(`
`),r=Math.max(s.length,o.length),a=[];for(let i=0;i<r;i++)s[i]!==o[i]&&a.push(i);return{lines:a,numLinesBefore:s.length,numLinesAfter:o.length,numLines:r}}var vs=globalThis.process.platform.startsWith("win"),Ee=Symbol("clack:cancel");function J(e){return e===Ee}function de(e,t){let s=e;s.isTTY&&s.setRawMode(t)}function ut({input:e=K.stdin,output:t=K.stdout,overwrite:s=!0,hideCursor:o=!0}={}){let r=q.createInterface({input:e,output:t,prompt:"",tabSize:1});q.emitKeypressEvents(e,r),e instanceof Ae.ReadStream&&e.isTTY&&e.setRawMode(!0);let a=(i,{name:n,sequence:l})=>{let u=String(i);if(Te([u,n,l],"cancel")){o&&t.write(E.cursor.show),process.exit(0);return}if(!s)return;q.moveCursor(t,n==="return"?0:-1,n==="return"?-1:0,()=>{q.clearLine(t,1,()=>{e.once("keypress",a)})})};return o&&t.write(E.cursor.hide),e.once("keypress",a),()=>{e.off("keypress",a),o&&t.write(E.cursor.show),e instanceof Ae.ReadStream&&e.isTTY&&!vs&&e.setRawMode(!1),r.terminal=!1,r.close()}}var pe=e=>"columns"in e&&typeof e.columns=="number"?e.columns:80,Re=e=>"rows"in e&&typeof e.rows=="number"?e.rows:20;function Z(e,t,s,o=s,r=s,a){let i=pe(e!=null?e:K.stdout);return z(t,i-s.length,{hard:!0,trim:!1}).split(`
`).map((n,l,u)=>{let g=a?a(n,l):n;return l===0?`${o}${g}`:l===u.length-1?`${r}${g}`:`${s}${g}`}).join(`
`)}function dt(e,t){var s,o;if("~standard"in e){let r=e["~standard"].validate(t);if(r instanceof Promise)throw new TypeError("Schema validation must be synchronous. Update `validate()` and remove any asynchronous logic.");return(o=(s=r.issues)==null?void 0:s.at(0))==null?void 0:o.message}return e(t)}var he=class{constructor(t,s=!0){_(this,"input");_(this,"output");_(this,"_abortSignal");_(this,"rl");_(this,"opts");_(this,"_render");_(this,"_track",!1);_(this,"_prevFrame","");_(this,"_subscribers",new Map);_(this,"_cursor",0);_(this,"state","initial");_(this,"error","");_(this,"value");_(this,"userInput","");let l=t,{input:o=K.stdin,output:r=K.stdout,render:a,signal:i}=l,n=ce(l,["input","output","render","signal"]);this.opts=n,this.onKeypress=this.onKeypress.bind(this),this.close=this.close.bind(this),this.render=this.render.bind(this),this._render=a.bind(this),this._track=s,this._abortSignal=i,this.input=o,this.output=r}unsubscribe(){this._subscribers.clear()}setSubscriber(t,s){var r;let o=(r=this._subscribers.get(t))!=null?r:[];o.push(s),this._subscribers.set(t,o)}on(t,s){this.setSubscriber(t,{cb:s})}once(t,s){this.setSubscriber(t,{cb:s,once:!0})}emit(t,...s){var a;let o=(a=this._subscribers.get(t))!=null?a:[],r=[];for(let i of o)i.cb(...s),i.once&&r.push(()=>o.splice(o.indexOf(i),1));for(let i of r)i()}prompt(){return new Promise(t=>{if(this._abortSignal){if(this._abortSignal.aborted)return this.state="cancel",this.close(),t(Ee);this._abortSignal.addEventListener("abort",()=>{this.state="cancel",this.close()},{once:!0})}this.rl=ct.default.createInterface({input:this.input,tabSize:2,prompt:"",escapeCodeTimeout:50,terminal:!0}),this.rl.prompt(),this.opts.initialUserInput!==void 0&&this._setUserInput(this.opts.initialUserInput,!0),this.input.on("keypress",this.onKeypress),de(this.input,!0),this.output.on("resize",this.render),this.render(),this.once("submit",()=>{this.output.write(E.cursor.show),this.output.off("resize",this.render),de(this.input,!1),t(this.value)}),this.once("cancel",()=>{this.output.write(E.cursor.show),this.output.off("resize",this.render),de(this.input,!1),t(Ee)})})}_isActionKey(t,s){return t==="	"}_shouldSubmit(t,s){return!0}_setValue(t){this.value=t,this.emit("value",this.value)}_setUserInput(t,s){this.userInput=t!=null?t:"",this.emit("userInput",this.userInput),s&&this._track&&this.rl&&(this.rl.write(this.userInput),this._cursor=this.rl.cursor)}_clearUserInput(){var t;(t=this.rl)==null||t.write(null,{ctrl:!0,name:"u"}),this._setUserInput("")}onKeypress(t,s){var o,r,a,i,n;if(this._track&&s.name!=="return"&&(s.name&&this._isActionKey(t,s)&&((o=this.rl)==null||o.write(null,{ctrl:!0,name:"h"})),this._cursor=(a=(r=this.rl)==null?void 0:r.cursor)!=null?a:0,this._setUserInput((i=this.rl)==null?void 0:i.line)),this.state==="error"&&(this.state="active"),s!=null&&s.name&&(!this._track&&T.aliases.has(s.name)&&this.emit("cursor",T.aliases.get(s.name)),T.actions.has(s.name)&&this.emit("cursor",s.name)),t&&(t.toLowerCase()==="y"||t.toLowerCase()==="n")&&this.emit("confirm",t.toLowerCase()==="y"),this.emit("key",t,s),(s==null?void 0:s.name)==="return"&&this._shouldSubmit(t,s)){if(this.opts.validate){let l=dt(this.opts.validate,this.value);l&&(this.error=l instanceof Error?l.message:l,this.state="error",(n=this.rl)==null||n.write(this.userInput))}this.state!=="error"&&(this.state="submit")}Te([t,s==null?void 0:s.name,s==null?void 0:s.sequence],"cancel")&&(this.state="cancel"),(this.state==="submit"||this.state==="cancel")&&this.emit("finalize"),this.render(),(this.state==="submit"||this.state==="cancel")&&this.close()}close(){var t;this.input.unpipe(),this.input.removeListener("keypress",this.onKeypress),this.output.write(`
`),de(this.input,!1),(t=this.rl)==null||t.close(),this.rl=void 0,this.emit(`${this.state}`,this.value),this.unsubscribe()}restoreCursor(){let t=z(this._prevFrame,process.stdout.columns,{hard:!0,trim:!1}).split(`
`).length-1;this.output.write(E.cursor.move(-999,t*-1))}render(){var s;let t=z((s=this._render(this))!=null?s:"",process.stdout.columns,{hard:!0,trim:!1});if(t!==this._prevFrame){if(this.state==="initial")this.output.write(E.cursor.hide);else{let o=xs(this._prevFrame,t),r=Re(this.output);if(this.restoreCursor(),o){let a=Math.max(0,o.numLinesAfter-r),i=Math.max(0,o.numLinesBefore-r),n=o.lines.find(l=>l>=a);if(n===void 0){this._prevFrame=t;return}if(o.lines.length===1){this.output.write(E.cursor.move(0,n-i)),this.output.write(E.erase.lines(1));let l=t.split(`
`);this.output.write(l[n]),this._prevFrame=t,this.output.write(E.cursor.move(0,l.length-n-1));return}else if(o.lines.length>1){if(a<i)n=a;else{let u=n-i;u>0&&this.output.write(E.cursor.move(0,u))}this.output.write(E.erase.down());let l=t.split(`
`).slice(n);this.output.write(l.join(`
`)),this._prevFrame=t;return}}this.output.write(E.erase.down())}this.output.write(t),this.state==="initial"&&(this.state="active"),this._prevFrame=t}}};var me=class extends he{constructor(s){var r,a;super(s,!1);_(this,"options");_(this,"cursor",0);this.options=s.options,this.value=[...(r=s.initialValues)!=null?r:[]];let o=Math.max(this.options.findIndex(({value:i})=>i===s.cursorAt),0);this.cursor=(a=this.options[o])!=null&&a.disabled?Y(o,1,this.options):o,this.on("key",(i,n)=>{n.name==="a"&&this.toggleAll(),n.name==="i"&&this.toggleInvert()}),this.on("cursor",i=>{switch(i){case"left":case"up":this.cursor=Y(this.cursor,-1,this.options);break;case"down":case"right":this.cursor=Y(this.cursor,1,this.options);break;case"space":this.toggleValue();break}})}get _value(){var s;return(s=this.options[this.cursor])==null?void 0:s.value}get _enabledOptions(){return this.options.filter(s=>s.disabled!==!0)}toggleAll(){let s=this._enabledOptions,o=this.value!==void 0&&this.value.length===s.length;this.value=o?[]:s.map(r=>r.value)}toggleInvert(){let s=this.value;if(!s)return;let o=this._enabledOptions.filter(r=>!s.includes(r.value));this.value=o.map(r=>r.value)}toggleValue(){this.value===void 0&&(this.value=[]);let s=this.value.includes(this._value);this.value=s?this.value.filter(o=>o!==this._value):[...this.value,this._value]}};var ht=class extends he{constructor(s){var a;super(s,!1);_(this,"options");_(this,"cursor",0);this.options=s.options;let o=this.options.findIndex(({value:i})=>i===s.initialValue),r=o===-1?0:o;this.cursor=(a=this.options[r])!=null&&a.disabled?Y(r,1,this.options):r,this.changeValue(),this.on("cursor",i=>{switch(i){case"left":case"up":this.cursor=Y(this.cursor,-1,this.options);break;case"down":case"right":this.cursor=Y(this.cursor,1,this.options);break}this.changeValue()})}get _selectedValue(){return this.options[this.cursor]}changeValue(){let s=this._selectedValue;this.value=s===void 0?void 0:s.value}};var c=require("util"),L=H(require("process"),1);var Le=require("fs"),bt=require("path"),se=H(_e(),1);function ys(){return L.default.platform!=="win32"?L.default.env.TERM!=="linux":!!L.default.env.CI||!!L.default.env.WT_SESSION||!!L.default.env.TERMINUS_SUBLIME||L.default.env.ConEmuTask==="{cmd::Cmder}"||L.default.env.TERM_PROGRAM==="Terminus-Sublime"||L.default.env.TERM_PROGRAM==="vscode"||L.default.env.TERM==="xterm-256color"||L.default.env.TERM==="alacritty"||L.default.env.TERMINAL_EMULATOR==="JetBrains-JediTerm"}var Pe=ys(),ws=()=>process.env.CI==="true";var y=(e,t)=>Pe?e:t,$s=y("\u25C6","*"),xt=y("\u25A0","x"),vt=y("\u25B2","x"),yt=y("\u25C7","o"),Ns=y("\u250C","T"),I=y("\u2502","|"),Q=y("\u2514","\u2014"),hr=y("\u2510","T"),mr=y("\u2518","\u2014"),Ss=y("\u25CF",">"),mt=y("\u25CB"," "),ks=y("\u25FB","[\u2022]"),pt=y("\u25FC","[+]"),gt=y("\u25FB","[ ]"),pr=y("\u25AA","\u2022"),gr=y("\u2500","-"),fr=y("\u256E","+"),br=y("\u251C","+"),xr=y("\u256F","+"),vr=y("\u2570","+"),yr=y("\u256D","+"),wr=y("\u25CF","\u2022"),$r=y("\u25C6","*"),Nr=y("\u25B2","!"),Sr=y("\u25A0","x"),wt=e=>{switch(e){case"initial":case"active":return(0,c.styleText)("cyan",$s);case"cancel":return(0,c.styleText)("red",xt);case"error":return(0,c.styleText)("yellow",vt);case"submit":return(0,c.styleText)("green",yt)}},$t=e=>{switch(e){case"initial":case"active":return(0,c.styleText)("cyan",I);case"cancel":return(0,c.styleText)("red",I);case"error":return(0,c.styleText)("yellow",I);case"submit":return(0,c.styleText)("green",I)}};function Nt(e,t){let s=[`${t?`${(0,c.styleText)("cyan",I)}  `:""}${e.join(" \u2022 ")}`];return t&&s.push((0,c.styleText)("cyan",Q)),s}var ft=(e,t,s,o,r,a=!1)=>{let i=t,n=0;if(a)for(let l=o-1;l>=s;l--){let u=e[l];if(u&&(i-=u.length),n++,i<=r)break}else for(let l=s;l<o;l++){let u=e[l];if(u&&(i-=u.length),n++,i<=r)break}return{lineCount:i,removals:n}},Be=({cursor:e,options:t,style:s,output:o=process.stdout,maxItems:r=Number.POSITIVE_INFINITY,columnPadding:a=0,rowPadding:i=4})=>{let n=pe(o)-a,l=Re(o),u=(0,c.styleText)("dim","..."),g=Math.max(l-i,0),d=Math.max(Math.min(r,g),5),w=0;e>=d-3&&(w=Math.max(Math.min(e-d+3,t.length-d),0));let p=d<t.length&&w>0,b=d<t.length&&w+d<t.length,h=Math.min(w+d,t.length),m=[],f=0;p&&f++,b&&f++;let v=w+(p?1:0),C=h-(b?1:0);for(let S=v;S<C;S++){let k=t[S],$=k?s(k,S===e):"",A=z($,n,{hard:!0,trim:!1}).split(`
`);m.push(A),f+=A.length}if(f>g){let S=0,k=0,$=f,A=e-v,P=g,j=()=>ft(m,$,0,A,P),G=()=>ft(m,$,A+1,m.length,P,!0);p?({lineCount:$,removals:S}=j(),$>P&&(b||(P-=1),{lineCount:$,removals:k}=G())):(b||(P-=1),{lineCount:$,removals:k}=G(),$>P&&(P-=1,{lineCount:$,removals:S}=j())),S>0&&(p=!0,m.splice(0,S)),k>0&&(b=!0,m.splice(m.length-k,k))}let R=[];p&&R.push(u);for(let S of m)for(let k of S)R.push(k);return b&&R.push(u),R};var Is=[`${(0,c.styleText)("dim","\u2191/\u2193")} to navigate`,`${(0,c.styleText)("dim","Space:")} select`,`${(0,c.styleText)("dim","Enter:")} confirm`],te=(e,t)=>e.split(`
`).map(s=>t(s)).join(`
`),Fe=e=>{var r,a;let t=(i,n)=>{var u,g;let l=(u=i.label)!=null?u:String(i.value);return n==="disabled"?`${(0,c.styleText)("gray",gt)} ${te(l,d=>(0,c.styleText)(["strikethrough","gray"],d))}${i.hint?` ${(0,c.styleText)("dim",`(${(g=i.hint)!=null?g:"disabled"})`)}`:""}`:n==="active"?`${(0,c.styleText)("cyan",ks)} ${l}${i.hint?` ${(0,c.styleText)("dim",`(${i.hint})`)}`:""}`:n==="selected"?`${(0,c.styleText)("green",pt)} ${te(l,d=>(0,c.styleText)("dim",d))}${i.hint?` ${(0,c.styleText)("dim",`(${i.hint})`)}`:""}`:n==="cancelled"?`${te(l,d=>(0,c.styleText)(["strikethrough","dim"],d))}`:n==="active-selected"?`${(0,c.styleText)("green",pt)} ${l}${i.hint?` ${(0,c.styleText)("dim",`(${i.hint})`)}`:""}`:n==="submitted"?`${te(l,d=>(0,c.styleText)("dim",d))}`:`${(0,c.styleText)("dim",gt)} ${te(l,d=>(0,c.styleText)("dim",d))}`},s=(r=e.required)!=null?r:!0,o=(a=e.showInstructions)!=null?a:!0;return new me({options:e.options,signal:e.signal,input:e.input,output:e.output,initialValues:e.initialValues,required:s,cursorAt:e.cursorAt,validate(i){if(s&&(i===void 0||i.length===0))return`Please select at least one option.
${(0,c.styleText)("reset",(0,c.styleText)("dim",`Press ${(0,c.styleText)(["gray","bgWhite","inverse"]," space ")} to select, ${(0,c.styleText)("gray",(0,c.styleText)("bgWhite",(0,c.styleText)("inverse"," enter ")))} to submit`))}`},render(){var d,w;let i=(d=e.withGuide)!=null?d:T.withGuide,n=Z(e.output,e.message,i?`${$t(this.state)}  `:"",`${wt(this.state)}  `),l=`${i?`${(0,c.styleText)("gray",I)}
`:""}${n}
`,u=(w=this.value)!=null?w:[],g=(p,b)=>{if(p.disabled)return t(p,"disabled");let h=u.includes(p.value);return b&&h?t(p,"active-selected"):h?t(p,"selected"):t(p,b?"active":"inactive")};switch(this.state){case"submit":{let p=this.options.filter(({value:h})=>u.includes(h)).map(h=>t(h,"submitted")).join((0,c.styleText)("dim",", "))||(0,c.styleText)("dim","none"),b=Z(e.output,p,i?`${(0,c.styleText)("gray",I)}  `:"");return`${l}${b}`}case"cancel":{let p=this.options.filter(({value:h})=>u.includes(h)).map(h=>t(h,"cancelled")).join((0,c.styleText)("dim",", "));if(p.trim()==="")return`${l}${(0,c.styleText)("gray",I)}`;let b=Z(e.output,p,i?`${(0,c.styleText)("gray",I)}  `:"");return`${l}${b}${i?`
${(0,c.styleText)("gray",I)}`:""}`}case"error":{let p=i?`${(0,c.styleText)("yellow",I)}  `:"",b=this.error.split(`
`).map((f,v)=>v===0?`${i?`${(0,c.styleText)("yellow",Q)}  `:""}${(0,c.styleText)("yellow",f)}`:`   ${f}`).join(`
`),h=l.split(`
`).length,m=b.split(`
`).length+1;return`${l}${p}${Be({output:e.output,options:this.options,cursor:this.cursor,maxItems:e.maxItems,columnPadding:p.length,rowPadding:h+m,style:g}).join(`
${p}`)}
${b}
`}default:{let p=i?`${(0,c.styleText)("cyan",I)}  `:"",b=l.split(`
`).length,h=o?Nt(Is,i):i?[(0,c.styleText)("cyan",Q)]:[],m=h.join(`
`),f=h.length+1;return`${l}${p}${Be({output:e.output,options:this.options,cursor:this.cursor,maxItems:e.maxItems,columnPadding:p.length,rowPadding:b+f,style:g}).join(`
${p}`)}
${m}
`}}}}).prompt()};var re=(e="",t)=>{var r,a;let s=(r=t==null?void 0:t.output)!=null?r:process.stdout,o=((a=t==null?void 0:t.withGuide)!=null?a:T.withGuide)?`${(0,c.styleText)("gray",Q)}  `:"";s.write(`${o}${(0,c.styleText)("red",e)}

`)},St=(e="",t)=>{var r,a;let s=(r=t==null?void 0:t.output)!=null?r:process.stdout,o=((a=t==null?void 0:t.withGuide)!=null?a:T.withGuide)?`${(0,c.styleText)("gray",Ns)}  `:"";s.write(`${o}${e}
`)},kt=(e="",t)=>{var r,a;let s=(r=t==null?void 0:t.output)!=null?r:process.stdout,o=((a=t==null?void 0:t.withGuide)!=null?a:T.withGuide)?`${(0,c.styleText)("gray",I)}
${(0,c.styleText)("gray",Q)}  `:"";s.write(`${o}${e}

`)};var Cs=e=>(0,c.styleText)("magenta",e),It=(u={})=>{var g=u,{indicator:e="dots",onCancel:t,output:s=process.stdout,cancelMessage:o,errorMessage:r,frames:a=Pe?["\u25D2","\u25D0","\u25D3","\u25D1"]:["\u2022","o","O","0"],delay:i=Pe?80:120,signal:n}=g,l=ce(g,["indicator","onCancel","output","cancelMessage","errorMessage","frames","delay","signal"]);var ee,W;let d=ws(),w,p,b=!1,h=!1,m="",f,v=performance.now(),C=pe(s),R=(ee=l==null?void 0:l.styleFrame)!=null?ee:Cs,S=x=>{let N=x>1?r!=null?r:T.messages.error:o!=null?o:T.messages.cancel;h=x===1,b&&(O(N,x),h&&typeof t=="function"&&t())},k=()=>S(2),$=()=>S(1),A=()=>{process.on("uncaughtExceptionMonitor",k),process.on("unhandledRejection",k),process.on("SIGINT",$),process.on("SIGTERM",$),process.on("exit",S),n&&n.addEventListener("abort",$)},P=()=>{process.removeListener("uncaughtExceptionMonitor",k),process.removeListener("unhandledRejection",k),process.removeListener("SIGINT",$),process.removeListener("SIGTERM",$),process.removeListener("exit",S),n&&n.removeEventListener("abort",$)},j=()=>{if(f===void 0)return;d&&s.write(`
`);let x=z(f,C,{hard:!0,trim:!1}).split(`
`);x.length>1&&s.write(se.cursor.up(x.length-1)),s.write(se.cursor.to(0)),s.write(se.erase.down())},G=x=>x.replace(/\.+$/,""),X=x=>{let N=(performance.now()-x)/1e3,B=Math.floor(N/60),V=Math.floor(N%60);return B>0?`[${B}m ${V}s]`:`[${V}s]`},ae=(W=l.withGuide)!=null?W:T.withGuide,ne=(x="")=>{b=!0,w=ut({output:s}),m=G(x),v=performance.now(),ae&&s.write(`${(0,c.styleText)("gray",I)}
`);let N=0,B=0;A(),p=setInterval(()=>{if(d&&m===f)return;j(),f=m;let V=R(a[N]),le;if(d)le=`${V}  ${m}...`;else if(e==="timer")le=`${V}  ${m} ${X(v)}`;else{let Wt=".".repeat(Math.floor(B)).slice(0,3);le=`${V}  ${m}${Wt}`}let Ot=z(le,C,{hard:!0,trim:!1});s.write(Ot),N=N+1<a.length?N+1:0,B=B<4?B+.125:0},i)},O=(x="",N=0,B=!1)=>{if(!b)return;b=!1,clearInterval(p),j();let V=N===0?(0,c.styleText)("green",yt):N===1?(0,c.styleText)("red",xt):(0,c.styleText)("red",vt);m=x!=null?x:m,B||(e==="timer"?s.write(`${V}  ${m} ${X(v)}
`):s.write(`${V}  ${m}
`)),P(),w()};return{start:ne,stop:(x="")=>O(x,0),message:(x="")=>{m=G(x!=null?x:m)},cancel:(x="")=>O(x,1),error:(x="")=>O(x,2),clear:()=>O("",0,!0),get isCancelled(){return h}}},kr={light:y("\u2500","-"),heavy:y("\u2501","="),block:y("\u2588","#")};var _s=[`${(0,c.styleText)("dim","\u2191/\u2193")} to navigate`,`${(0,c.styleText)("dim","Enter:")} confirm`],ge=(e,t)=>e.includes(`
`)?e.split(`
`).map(s=>t(s)).join(`
`):t(e),Me=e=>{var o;let t=(r,a)=>{var n,l;if(r===void 0)return"";let i=(n=r.label)!=null?n:String(r.value);switch(a){case"disabled":return`${(0,c.styleText)("gray",mt)} ${ge(i,u=>(0,c.styleText)("gray",u))}${r.hint?` ${(0,c.styleText)("dim",`(${(l=r.hint)!=null?l:"disabled"})`)}`:""}`;case"selected":return`${ge(i,u=>(0,c.styleText)("dim",u))}`;case"active":return`${(0,c.styleText)("green",Ss)} ${i}${r.hint?` ${(0,c.styleText)("dim",`(${r.hint})`)}`:""}`;case"cancelled":return`${ge(i,u=>(0,c.styleText)(["strikethrough","dim"],u))}`;default:return`${(0,c.styleText)("dim",mt)} ${ge(i,u=>(0,c.styleText)("dim",u))}`}},s=(o=e.showInstructions)!=null?o:!0;return new ht({options:e.options,signal:e.signal,input:e.input,output:e.output,initialValue:e.initialValue,render(){var u;let r=(u=e.withGuide)!=null?u:T.withGuide,a=`${wt(this.state)}  `,i=`${$t(this.state)}  `,n=Z(e.output,e.message,i,a),l=`${r?`${(0,c.styleText)("gray",I)}
`:""}${n}
`;switch(this.state){case"submit":{let g=r?`${(0,c.styleText)("gray",I)}  `:"",d=Z(e.output,t(this.options[this.cursor],"selected"),g);return`${l}${d}`}case"cancel":{let g=r?`${(0,c.styleText)("gray",I)}  `:"",d=Z(e.output,t(this.options[this.cursor],"cancelled"),g);return`${l}${d}${r?`
${(0,c.styleText)("gray",I)}`:""}`}default:{let g=r?`${(0,c.styleText)("cyan",I)}  `:"",d=l.split(`
`).length,w=s?Nt(_s,r):r?[(0,c.styleText)("cyan",Q)]:[],p=w.join(`
`),b=w.length+1;return`${l}${g}${Be({output:e.output,cursor:this.cursor,options:this.options,maxItems:e.maxItems,columnPadding:g.length,rowPadding:d+b,style:(h,m)=>t(h,h.disabled?"disabled":m?"active":"inactive")}).join(`
${g}`)}
${p}
`}}}}).prompt()};var Ir=`${(0,c.styleText)("gray",I)}  `;var F=H(At()),$e=H(require("fs")),We=H(require("path"));var Et={id:"dark-saas-pro",name:"Dark SaaS Pro (Universal Architecture)",iconName:"Moon",description:"An exhaustive, ultra-detailed modern dark theme inspired by Linear, Vercel, and Raycast. Universal architecture suited for SaaS, Portfolios, E-Commerce, and Blogs. Features deep blue-black backgrounds, vibrant purple accents, and glassmorphism.",shortDescription:"Universal dark mode for SaaS, Portfolios & E-Commerce",tier:"pro",previewImage:"/vibes/dark-saas-pro.png",colors:{background:"hsl(222, 47%, 6%)",surface50:"hsl(222, 30%, 8%)",surface100:"hsl(222, 30%, 10%)",surface200:"hsl(222, 30%, 12%)",surface300:"hsl(222, 30%, 14%)",surface400:"hsl(222, 30%, 16%)",surface500:"hsl(222, 30%, 18%)",surface600:"hsl(222, 30%, 20%)",surface700:"hsl(222, 30%, 24%)",surface800:"hsl(222, 30%, 28%)",surface900:"hsl(222, 30%, 32%)",surface:"hsl(222, 30%, 10%)",surfaceHover:"hsl(222, 30%, 14%)",surfaceActive:"hsl(222, 30%, 16%)",elevated:"hsl(222, 25%, 12%)",elevatedHover:"hsl(222, 25%, 16%)",border:"hsl(222, 20%, 18%)",borderSubtle:"hsl(222, 15%, 14%)",borderHover:"hsl(222, 20%, 25%)",borderActive:"hsl(222, 20%, 30%)",textPrimary:"hsl(210, 40%, 98%)",textSecondary:"hsl(215, 20%, 65%)",textTertiary:"hsl(215, 15%, 45%)",textMuted:"hsl(215, 10%, 35%)",textInverse:"hsl(222, 47%, 6%)",accent50:"hsl(262, 83%, 95%)",accent100:"hsl(262, 83%, 90%)",accent200:"hsl(262, 83%, 80%)",accent300:"hsl(262, 83%, 70%)",accent400:"hsl(262, 83%, 65%)",accent500:"hsl(262, 83%, 58%)",accent600:"hsl(262, 83%, 50%)",accent700:"hsl(262, 83%, 40%)",accent800:"hsl(262, 83%, 30%)",accent900:"hsl(262, 83%, 20%)",accent950:"hsl(262, 83%, 10%)",accent:"hsl(262, 83%, 65%)",accentHover:"hsl(262, 83%, 58%)",accentMuted:"hsl(262, 60%, 30%)",secondary50:"hsl(210, 100%, 95%)",secondary100:"hsl(210, 100%, 90%)",secondary200:"hsl(210, 100%, 80%)",secondary300:"hsl(210, 100%, 70%)",secondary400:"hsl(210, 100%, 60%)",secondary500:"hsl(210, 100%, 50%)",secondary600:"hsl(210, 100%, 40%)",secondary700:"hsl(210, 100%, 30%)",secondary800:"hsl(210, 100%, 20%)",secondary900:"hsl(210, 100%, 10%)",success50:"hsl(142, 71%, 95%)",success100:"hsl(142, 71%, 90%)",success200:"hsl(142, 71%, 80%)",success300:"hsl(142, 71%, 70%)",success400:"hsl(142, 71%, 55%)",success500:"hsl(142, 71%, 45%)",success600:"hsl(142, 71%, 35%)",success700:"hsl(142, 71%, 25%)",success800:"hsl(142, 71%, 15%)",success900:"hsl(142, 71%, 10%)",success:"hsl(142, 71%, 45%)",warning50:"hsl(38, 92%, 95%)",warning100:"hsl(38, 92%, 90%)",warning200:"hsl(38, 92%, 80%)",warning300:"hsl(38, 92%, 70%)",warning400:"hsl(38, 92%, 60%)",warning500:"hsl(38, 92%, 50%)",warning600:"hsl(38, 92%, 40%)",warning700:"hsl(38, 92%, 30%)",warning800:"hsl(38, 92%, 20%)",warning900:"hsl(38, 92%, 10%)",warning:"hsl(38, 92%, 50%)",error50:"hsl(0, 84%, 95%)",error100:"hsl(0, 84%, 90%)",error200:"hsl(0, 84%, 80%)",error300:"hsl(0, 84%, 70%)",error400:"hsl(0, 84%, 60%)",error500:"hsl(0, 84%, 50%)",error600:"hsl(0, 84%, 40%)",error700:"hsl(0, 84%, 30%)",error800:"hsl(0, 84%, 20%)",error900:"hsl(0, 84%, 10%)",error:"hsl(0, 84%, 60%)",info:"hsl(199, 89%, 48%)"},typography:{fontFamily:"Inter, system-ui, sans-serif",fontFamilyMono:"JetBrains Mono, Fira Code, monospace",display1:"text-7xl md:text-9xl font-black tracking-tighter leading-none",display2:"text-6xl md:text-8xl font-black tracking-tighter leading-[1.1]",hero:"text-5xl md:text-7xl font-bold tracking-tight leading-[1.15]",h1:"text-4xl md:text-5xl font-bold tracking-tight leading-tight",h2:"text-3xl md:text-4xl font-semibold tracking-tight leading-snug",h3:"text-2xl md:text-3xl font-semibold tracking-tight leading-snug",h4:"text-xl md:text-2xl font-medium tracking-tight leading-normal",h5:"text-lg md:text-xl font-medium tracking-tight leading-normal",h6:"text-base md:text-lg font-medium leading-normal",bodyLarge:"text-lg md:text-xl leading-relaxed",body:"text-base leading-relaxed",bodySmall:"text-sm leading-relaxed",small:"text-sm font-medium",xs:"text-xs font-medium",micro:"text-[10px] font-bold uppercase tracking-wider",code:"font-mono text-sm tracking-tight",codeSmall:"font-mono text-xs tracking-tight",prose:"prose prose-invert prose-p:leading-relaxed prose-headings:tracking-tight prose-a:text-[hsl(262,83%,65%)] hover:prose-a:text-[hsl(262,83%,58%)] max-w-none"},animationRules:["Use fade-in with translateY(12px) for page content appearing, duration 400ms ease-out, staggered by 50ms for siblings.","Use framer-motion <AnimatePresence mode='wait'> for route transitions, fading out current content before scaling in new content (scale from 0.98 to 1).","Cards should translateY(-4px) and add a prominent border glow ([hsl(262,83%,65%)/0.4]) on hover. Duration 300ms cubic-bezier(0.4, 0, 0.2, 1).","Buttons should scale(0.97) on active press and scale(1.03) on hover.","Links should have an under-animated underline that expands from left to right on hover.","Add a subtle pulse-glow animation to primary CTA buttons (box-shadow pulsing from 20% to 50% opacity every 2s)."],specialInstructions:["UNIVERSAL ADAPTABILITY: This design system is built to be universally adaptable. Whether the user asks for a Developer Portfolio, a SaaS Dashboard, an E-commerce Store, or a Blog, apply these colors, typography, and glassmorphism rules seamlessly. DO NOT ask the user what they want; execute their prompt immediately using this theme.","IMAGE ASSETS: Use relevant high-quality placeholders for images. If building a portfolio, use mock project screenshots or tech-themed abstract images. If e-commerce, use sleek product mockups. Always apply a subtle dark overlay or blend mode (mix-blend-luminosity) to make images blend into the dark theme.","This design favors extreme depth and layering. Use multiple surface levels (background -> surface -> elevated -> overlay) and shadow layers to create visual hierarchy.","Glassmorphism (backdrop-blur) should be used for sticky navigation, floating command palettes, and modal overlays. Avoid using it for dense content cards as it impacts performance.","Always add a subtle grid background pattern (40px or 60px grid with very low opacity lines) to hero sections and empty states for visual texture."],componentPatterns:[{name:"Badge (Solid)",description:"Solid background badge for high emphasis status.",classes:"inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-[hsl(262,83%,65%)] text-white shadow-sm shadow-[hsl(262,83%,65%)/0.3]"},{name:"Badge (Subtle)",description:"Subtle background badge for low emphasis status or categories (good for blog tags or portfolio skills).",classes:"inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-[hsl(262,83%,65%)/0.1] text-[hsl(262,83%,65%)] border border-[hsl(262,83%,65%)/0.2]"},{name:"Button Primary",description:"Primary action button with glow. Use for main CTAs.",classes:"inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium ring-offset-[hsl(222,47%,6%)] transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(262,83%,65%)] focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-[hsl(262,83%,65%)] text-white hover:bg-[hsl(262,83%,58%)] shadow-lg shadow-[hsl(262,83%,65%)/0.25] hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98] h-11 px-8"},{name:"Button Outline",description:"Outline button for secondary actions.",classes:"inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium ring-offset-[hsl(222,47%,6%)] transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(262,83%,65%)] focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-[hsl(222,20%,25%)] bg-transparent hover:bg-[hsl(222,20%,18%)] hover:text-white text-[hsl(210,40%,98%)] h-11 px-8"},{name:"Card Base",description:"Standard elevated surface for projects, products, or dashboard panels.",classes:"rounded-2xl border border-[hsl(222,20%,18%)] bg-[hsl(222,30%,10%)] text-[hsl(210,40%,98%)] shadow-lg shadow-black/20 overflow-hidden"},{name:"Card Interactive",description:"Card with hover effects for clickable items like portfolio projects or blog posts.",classes:"rounded-2xl border border-[hsl(222,20%,18%)] bg-[hsl(222,30%,10%)] text-[hsl(210,40%,98%)] shadow-lg shadow-black/20 overflow-hidden transition-all duration-300 hover:border-[hsl(262,83%,65%)/0.5] hover:shadow-[0_8px_30px_rgb(0,0,0,0.4)] hover:-translate-y-1 group cursor-pointer"},{name:"Glass Header",description:"Sticky navigation bar with glassmorphism.",classes:"sticky top-0 z-50 w-full border-b border-[hsl(222,20%,18%)/0.5] bg-[hsl(222,47%,6%)/0.8] backdrop-blur-xl supports-[backdrop-filter]:bg-[hsl(222,47%,6%)/0.6]"},{name:"Input Base",description:"Standard text input for contact forms, search, or settings.",classes:"flex h-11 w-full rounded-xl border border-[hsl(222,20%,18%)] bg-[hsl(222,30%,10%)] px-4 py-2 text-sm text-[hsl(210,40%,98%)] ring-offset-[hsl(222,47%,6%)] file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-[hsl(215,15%,45%)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(262,83%,65%)] focus-visible:border-[hsl(262,83%,65%)] focus-visible:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50 transition-all"}],enterpriseBlueprints:[{title:"Universal Hero Section (Portfolio/Landing)",description:"A highly impactful hero section suitable for a developer portfolio or product landing page. Features glowing abstract backgrounds and dual CTAs.",language:"tsx",code:`// src/components/hero.tsx
   ...
   \\ \\    / (_) |         
    \\ \\  / / _| |__   ___ 
     \\ \\/ / | | '_ \\ / _ \\
      \\  /  | | |_) |  __/
       \\/   |_|_.__/ \\___| craftz
  `)),St(F.default.bgMagenta(F.default.black(" VIBECRAFTZ CLI - AI System Instruction Generator ")));let e=await Me({message:"Select a Design Vibe:",options:ie.map(i=>({value:i.id,label:i.name,hint:i.tier!=="free"?F.default.yellow("(Pro)"):F.default.green("(Free)")}))});if(J(e))return re("Operation cancelled."),process.exit(0);let t={framework:"",styling:"",components:"",icons:"",animation:"",database:"",auth:"",deploy:""};for(let i of Dt){let n=De.filter(l=>l.category===i);if(n.length>0){let l=await Me({message:`Select ${i.charAt(0).toUpperCase()+i.slice(1)}:`,options:n.map(u=>({value:u.id,label:u.name}))});if(J(l))return re("Operation cancelled."),process.exit(0);t[i]=l}}let s=await Fe({message:"Select AI Rules to enforce:",options:oe.map(i=>({value:i.id,label:i.name,hint:i.tier!=="free"?F.default.yellow("(Pro)"):""})),required:!1});if(J(s))return re("Operation cancelled."),process.exit(0);let o=await Fe({message:"Select Target IDE(s) or Format:",options:Ue.map(i=>({value:i.id,label:i.name,hint:i.fileName})),required:!0});if(J(o))return re("Operation cancelled."),process.exit(0);let r={vibe:e,stacks:t,rules:s,targetIdes:o},a=It();a.start("Generating system instructions...");try{let i=Gt({config:r,userTier:"pro_plus"});a.stop("Generated successfully!");for(let n of i){let l=We.default.join(process.cwd(),n.fileName),u=We.default.dirname(l);$e.default.existsSync(u)||$e.default.mkdirSync(u,{recursive:!0}),$e.default.writeFileSync(l,n.content,"utf-8"),console.log(`${F.default.green("\u2714")} Created ${F.default.cyan(n.fileName)}`)}kt(F.default.green("You're all set! Enjoy your tailored AI assistant."))}catch(i){a.stop("Generation failed."),console.error(F.default.red(i instanceof Error?i.message:"Unknown error")),process.exit(1)}}Ls().catch(e=>{console.error(e),process.exit(1)});
